...
Contributors: artibot
Donate link: https://www.artibot.ai
Tags: chat bot, chatbot, bots, online leads, conversational, lead capture, bot leads, automatic leads, live chat bot, lead generation, lead gen, demand generation, demand gen, super leads, powerful leads, 24/7 leads, twenty four seven leads, leads while I sleep, new leads, lead capture, automatic live chat, automatic chat, AI, Artificial Intelligence Chat, free AI, free live chat, AI-powered lead capture tool, lead capture tool, AI-powered, collect the leads on your website, chat template, bot, chat, Google Calender, Stripe
...
For more information, visit [ArtiBot.ai](https://artibot.ai "ArtiBot")
...
You can change all your ArtiBot settings from your [ArtiBot dashboard](https://artibot.ai/bots/ "ArtiBot dashboard").
...
= 1.1.5 =
* Updated Widget Selection

= 1.1.4 =
* Updated Images,Title, and Widget Selection

= 1.1.3 =
* Updated Images and Description

= 1.1.2 =
* Updated Images and Plugin Page

= 1.1.1 =
* Updated Images

= 1.1.0 =
* Updated Wordpress Snippet

= 1.0.1 =
* Updated ArtiBot Landing Page.
